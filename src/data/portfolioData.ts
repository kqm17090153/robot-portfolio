...
export const portfolioImages = {
  heroWorkshop: heroWorkshopImg,
  redTower: redTowerImg,
...
export const competitionData = {
  ...
  role: {
    ...
    name: {
      ko: '프로그래밍, 로봇 수리',
      en: 'Lead Programmer & Hardware Repair',
    },
  },
  summaryTitle: {
    ko: 'Trial & Error Logs',
  ...
  summarySubtitle: {
    ko: '대회를 통해 배우고 기록한 생생한 시행착오 일지입니다.',
    en: 'Documenting the journey of learning through competitive robotics.',
  },
  highlightQuote: {
    ko: '"배운 것은 많았지만 다 쓰진 못했던 대회"',
    en: '"A competition where I learned immense lessons even if I couldn\'t showcase everything yet"',
  },
};

export const trialLogsData: TrialLog[] = [
  {
    id: 'quick-repairs',
    type: 'success',
    title: {
...
export const githubRepoInfo = {
  title: {
    ko: 'View GitHub Repository',
    en: 'View GitHub Repository',
  },
  subtitle: {
    ko: 'Explore source code and schematic files.',
    en: 'Explore source code and schematic files.',
  },
  repoName: 'robotfolio/wro-2026-robotics-core',
  branch: 'main',
  stars: 48,
  forks: 12,
  files: [
    { name: 'firmware/main_control.py', size: '14.2 KB', desc: 'Main autonomous state machine & sensor loop' },
    { name: 'firmware/kinematics.py', size: '8.7 KB', desc: 'Inverse kinematics trigonometric solver' },
    { name: 'firmware/pid_motor.py', size: '6.1 KB', desc: 'Closed-loop dual encoder speed PID driver' },
    { name: 'cad/chassis_v2.step', size: '2.4 MB', desc: '3D CAD printable modular robot frame' },
    { name: 'cad/claw_gripper.stl', size: '1.8 MB', desc: 'Dual-geared parallel gripper mechanism' },
    { name: 'schematics/esp32_shield.pdf', size: '840 KB', desc: 'Custom PCB power regulation & I/O breakout' },
    { name: 'README.md', size: '5.3 KB', desc: 'Documentation, match strategy, and trial logs' },
  ],
};
